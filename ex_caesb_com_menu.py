...
def inputsmenu():
    ...
    categoria = ''
    menu(consumo, quantidade_de_unidades, consumo_medio, categoria)


def menu(consumo, quantidade_de_unidades, consumo_medio, categoria):
    categoria = int(input
    ''' Qual categoria você pertence:
    1 - residencial
    2 - nao-residencial
    3 - sair do programa
